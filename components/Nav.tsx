    ...
    >
      <div className="mx-auto flex h-16 max-w-content items-center justify-between px-5 sm:px-8">
        <a href="#top" className="focus-ring flex items-baseline gap-2 rounded-sm">
          ...
          <span className="text-[11px] uppercase tracking-[0.28em] text-gold-500">Cards</span>
        </a>
        ...
        <div className="flex items-center gap-3">
          <a
            href="#pricing"
            className="focus-ring hidden rounded-full bg-white px-4 py-2 text-sm font-medium text-ink-950 transition-[transform,background-color] duration-150 ease-smooth hover:bg-gold-400 active:scale-[0.97] sm:inline-flex"
          >
            Order now
          </a>
          <button
